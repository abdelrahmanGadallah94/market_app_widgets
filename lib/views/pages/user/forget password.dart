...
import 'package:market_app2/views/pages/user/registeration.dart';
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomButton(text: "Send new password",path: (){
                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => Registeration()));
                          }),
                        ],
                      ),
                    )
